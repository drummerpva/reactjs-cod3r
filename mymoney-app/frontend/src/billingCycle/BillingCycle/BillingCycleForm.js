      ...
      <form  onSubmit={handleSubmit}  >
        <div className="box-body">
          ...
          <Summary  
            ...
            debit={sumOfDebits} 
          />
          <ItemList field='credits' legend='Créditos' cols='12 6' readOnly={readOnly} list={credits} />
          <ItemList field='debits' showStatus legend='Débitos' cols='12 6' readOnly={readOnly} list={debits} />
